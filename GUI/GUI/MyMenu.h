...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Text = L"Początkujący";
...
#pragma endregion
	...
	private: System::Void button8_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		if (x == ""|| y == "" || bomb=="")
		{
			MessageBox::Show("Wpisz dane wejśćiowe odnośnie ilości pól i min");
		}
		else 
		{
			...
			{
				MessageBox::Show("Niepoprawna ilość kolumn"+"\n"+"Ilość kolumn musi być z zakresu od 8 do 30");
			}
			else if (boardRow < 8 || boardRow>24)
			{
				MessageBox::Show("Niepoprawna ilość wierszy" + "\n" + "Ilość wierszy musi być z zakresu od 8 do 24");
			}
			else if ((boardBomb < 10 || boardBomb>240)|| boardBomb > boardCol* boardRow/3)
			{
				MessageBox::Show("Niepoprawna ilość bomb");
			}
			else 
			{
				this->DialogResult = System::Windows::Forms::DialogResult::OK;
